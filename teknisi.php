...
include "get-number-waiting.php";
    ...
    $sql = "SELECT t.id_teknisi, t.nik, t.nama, t.no_wa, COUNT(k.id_kegiatan) AS total_kegiatan
            FROM teknisi t
            LEFT JOIN kegiatan k ON t.id_teknisi = k.id_teknisi
                        ...
                        $no = 1;
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>" . $no . "</td>";
                                    echo "<td>" . $row["nik"] . "</td>";
                                    echo "<td><a href='teknisi_detail.php?id_teknisi=" . $id_teknisi . "'>" . $row['nama'] . "</a></td>";
                                    ...
                                    // Tombol Delete
                                        ?>
                                        <td><button class='btn btn-danger' onclick='deleteTek("<?php echo $nik; ?>")'><i class='far fa-trash-alt'></i></button></td>
                                        <?php
                                    echo "</tr>";
                                    $no++;
                                }
