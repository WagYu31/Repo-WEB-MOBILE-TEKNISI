...
echo "<h2>Migrasi Database: Menambahkan Fitur Wilayah</h2>";
...
// 4. Masukkan data wilayah awal jika kosong
...
// 5. Update data sales & customer lama yang id_wilayah-nya masih NULL ke Jabodetabek (ID 1)
