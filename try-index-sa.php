                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="listTek">
                                        <?php
                                            $cariTek = "SELECT * FROM teknisi";
                                            $resultCariTek = mysqli_query($conn, $cariTek);
                                            while($rowCariTek = mysqli_fetch_assoc($conn, $resultCariTek)){
                                                $resNamaTek = $rowCariTek['nama'];
                                                $resIDTek = $rowCariTek['id_teknisi'];
                                                ?>
                                                <option value="<?php echo $resIDTek;?>"><?php echo $resNamaTek;?></option>
                                                <?php
                                            }
                                        ?>
                                        </select>
