                ...
                <!--Bagian 2-->
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered tek">
                                ...
                                if($status == "Reschedule" || $status == "Reschedule2" || $status == "Pause"){
                                    ...
                                    $namaHariIndonesiaReq = "";
                                        ...
                                        if ($tgl_res != '0000-00-00 00:00:00') {
                                            echo "<td style='background-color:yellow; font-weight:bold;'>" . $sts. " - " . $namaHariIndonesiaReq . ", " . $formattedDateReq . " " . $formattedTimeReq . "</td>";
                                        } else {
                                            echo "";
                                        }
                            ...
                            <tr>
                                <th>Customer</th>
                                <?php echo "<td>" . $row["nama_customer"] . "</td>";?>
                            </tr>
                                <?php
                            ...
                            <tr>
                                <th>Tanggal</th>
                                <?php echo "<td>" . $namaHariIndonesia . ", " . $formattedDate . "</td>";?>
                            </tr>
                                <th>Jam</th>
                                <?php echo "<td>" . $formattedTime . "</td>"; ?>
                            </tr>
                            <tr>
                                <th>Keterangan</th>
                                ...
                                <?php
                                            if($role == "Teknisi"){
                                                if($row["status"] == "Pending" OR $row["status"] == "Reschedule"){
                                                ?>
                                                <tr>
                                                <th>Aksi</th>
                                                    <td>
                                                    <button class="btn btn-primary start-btn" data-id="<?php echo $row['id_kegiatan']; ?>">Mulai</button>
                                                    <button class="btn btn-primary sync-btn" data-id="<?php echo $row['id_kegiatan']; ?>">Reschedule</button>
                                                    <!--<i class="fas fa-sync"></i><i class="fas fa-play"></i><i class="fas fa-thumbs-up"><i class="fas fa-pause"></i>-->
                                                    </td>
                                                </tr>
                                                <?php
                                                }
                                                ...
                                                <th>Aksi</th>
                                                    <td><!-- Tombol Pause -->
                                                    <button class="btn btn-success pause-btn" data-toggle="modal" data-target="#pauseModal" data-id="<?php echo $row['id_kegiatan']; ?>">Lanjut Nanti</button>
                                                    <a class="btn btn-success finish-btn" href="detail-kegiatan-finish-kegiatan.php?id_kegiatan=<?php echo $row['id_kegiatan']; ?>">Selesai</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                }
                                                else if($row["status"] == "Pause" OR $row["status"] == "Reschedule2"){
                                                ?>
                                                <tr>
                                                <th>Aksi</th>
                                                    <td>
                                                    <button class="btn btn-primary start-pause-btn" data-id="<?php echo $row['id_kegiatan']; ?>">Mulai</button>
                                                    <button class="btn btn-primary sync-pause-btn" data-id="<?php echo $row['id_kegiatan']; ?>">Reschedule</button>
                                                    </td>
                                                </tr>
                                                <?php
                                                }
