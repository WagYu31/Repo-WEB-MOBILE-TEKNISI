...
<body id="body-pd">
    <div class="container-fluid">
        <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-md-4 mb-1 mt-5">
          <div class="card">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-md-4 mb-1 mt-md-5 mt-1">
          <div class="card darkBlue">
            ...
            <div class="card-footer p-3 darkBlue">
              <a href="admin-dijadwalkan.php"><p class="mb-0">Selengkapnya<span class="float-end mt-1"><i class='bx bxs-chevron-right'></i></span></p></a>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-md-4 mb-1 mt-md-5 mt-1">
          <div class="card   active-card-border">
            ...
            <div class="card-footer p-3   active-card-border  active-card-bg">
              <a href="admin-selesai.php"><p class="mb-0">Selengkapnya<span class="float-end mt-1"><i class='bx bxs-chevron-right'></i></span></p></a>
            </div>
          </div>
        </div>
        </div>
                            ...
                            <?php
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $groupedData[$kodeTransaksi]['tgl_selesai'][] = $row['tgl_selesai'];
                                ...
                                foreach ($groupedData as $kodeTransaksi => $data) {
                                    ...
                                    $smallestDateTime = strtotime($data["tgl_selesai"][0]);
                                    
                                    foreach ($data["tgl_selesai"] as $index => $datetime) {
                                    ...
                                    $selectedDatetime = $data["tgl_selesai"][$smallestIndex];
