...
include "get-number-waiting.php";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (mysqli_num_rows($checkCustomerResult) > 0 && !$duplikat) {
            ...
            $sql = "INSERT INTO customer (nama, nomor_tlp, alamat) VALUES ('$nama', '$no_tlp', '$alamat')";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main id="content" class="mx-auto">
                <div class="container">
                    <h2>Input Data Customer Baru</h2>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="no_whatsapp" name="no_tlp" placeholder="Masukkan No WhatsApp" required>
                            </div>
                        </div>

                        <!-- <div class="form-group">
                            <label for="no_telepon">No Telepon</label>
                            <input type="text" class="form-control" id="no_telepon" na placeholder="Masukkan No Telepon">
                        </div> -->
                        <div class="form-group">
