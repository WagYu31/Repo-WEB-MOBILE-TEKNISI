...
class StatusPinjamProvider extends ChangeNotifier{
  final ApiPinjam api;

  StatusPinjamProvider({required this.api});
  ...
  Future<dynamic> doUpdateStatus(
    ...
    try{
      ...
      final responses = await api.updateStatus(status, code);
      ...
      if(responses.message == 'Status updated successfully'){
