<?php
$sqlAkan = "SELECT k.*, t.nama AS nama_teknisi, c.nama AS nama_customer 
        FROM kegiatan k
        ...
        ORDER BY 
            COALESCE(k.tgl_reschedule, k.tgl_mulai), 
            k.tgl_request";


    $resultAkan = mysqli_query($conn, $sqlAkan);
    ?>
                    <h2>Data Kegiatan Yang Akan Datang</h2>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                                ...
                                if (mysqli_num_rows($resultAkan) > 0) {
                                    while ($row = mysqli_fetch_assoc($resultAkan)) {
