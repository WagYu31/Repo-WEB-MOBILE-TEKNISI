...
<div class="loader"></div>
    <div class="container-fluid">
                    ...
                    <div class="bottom-navigation row m-0 p-0">
                        ...
                        ?>
                            ...
                            ?>
                                ...
                                <div class="col-md-6 m-0 p-0">
                                    <a class="btn btn-success finish-btn btn-block p-3" href="detail-kegiatan-finish-kegiatan.php?id_kegiatan=<?php echo $row['id_kegiatan']; ?>">Selesai</a>
                                </div>
                            <?php
        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="startModalLabel" aria-hidden="true">
