                ...
                <nav class="nav">
                    <div> <a href="#" class="nav_logo"> <img src="img/logo2.png" width="50px"></img> <span class="nav_logo-name">Loewix</span> </a>
                        <div class="nav_list">
                            ...
                            <a href="cek-resi.php" class="nav_link active"> <i class='bx bx-task nav_icon'></i> <span class="nav_name">Cek Status</span> </a>
                        </div>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center">
                ...
                <div id="result" class="mt-4">
                    <img src="img/loewix.png" width="100px">
...
switch (result.status_kegiatan) {
    case "Waiting":
        resultContainer.innerHTML += `<p>Status Permohonan : Menunggu Dijadwalkan</p>`;
        document.querySelector(".progress-bar").style.width = "25%";
        document.querySelector(".progress-bar").style.backgroundColor = "red";
        break;
    case "Pending":
        resultContainer.innerHTML += `<p>Status Permohonan : Telah Dijadwalkan</p>`;
        document.querySelector(".progress-bar").style.width = "50%";
        document.querySelector(".progress-bar").style.backgroundColor = "yellow";
        break;
    case "Pause":
        resultContainer.innerHTML += `<p>Status Permohonan : Akan di Lanjutkan Nanti</p>`;
        document.querySelector(".progress-bar").style.width = "50%";
        document.querySelector(".progress-bar").style.backgroundColor = "yellow";
        break;
    case "Reschedule":
    case "Reschedule2":
        resultContainer.innerHTML += `<p>Status Permohonan : Dijadwalkan Ulang</p>`;
        document.querySelector(".progress-bar").style.width = "50%";
        document.querySelector(".progress-bar").style.backgroundColor = "yellow";
        break;
    case "On Process":
        resultContainer.innerHTML += `<p>Status Permohonan : Sedang Dalam Proses</p>`;
        document.querySelector(".progress-bar").style.width = "75%";
        document.querySelector(".progress-bar").style.backgroundColor = "blue";
        break;
    case "Clear":
        resultContainer.innerHTML += `<p>Status Permohonan : Telah Selesai</p>`;
