    ...
    <div class="container mt-2">
        <form action="submit_invoice.php" method="post">
            ...
            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" role="switch" id="feeToggle" name="tambah_fee">
                <label class="form-check-label" for="feeToggle">Tambahkan Fee Teknisi</label>
            </div>
