<div class="col-lg-12 mt-0 mb-0">
    <div class="row">
        <div class="col-12">
            <button id="toggleLoadMore1" type="button" class="btn bg-gradient-info font-weight-bold" style="font-size:16px;">Kegiatan Hari Ini</button>
        </div>
    </div>
</div>
<div class="col-lg-12 mt-n3 mb-4" id="loadMoreX1" style="display: block;">
    <div class="card h-100 py-3" style="border-top-left-radius:0;">
        ...
        $sql = "SELECT v.*, s.nama AS nama_sales, c.nama AS nama_customer, c.no_wa AS cust_nomor
                ...
                WHERE v.status != 'clear' AND DATE(v.tgl_visits) = '$current_date'
            ...
            <ul class="list-group m-0 mt-2 col-12" id="data-tek">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($isMobile) {
                            include "kegiatan-db-sales-mobile.php";
                        } else {
                            include "kegiatan-db-sales-dekstop.php";
                        }
