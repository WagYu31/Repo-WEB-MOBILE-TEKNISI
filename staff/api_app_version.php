...
// ═══════════════════════════════════════════════
$response = [
    'min_version'     => '4.0.20',   // Versi minimum yang dibolehkan
    'latest_version'  => '4.0.20',   // Versi terbaru yang tersedia
    'update_url'      => 'https://jadwal.id-giti.com/staff/download/teknisi-latest.apk?v=4.0.20', // URL download APK
