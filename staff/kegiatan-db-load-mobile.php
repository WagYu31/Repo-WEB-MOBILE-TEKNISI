<li class="list-group-item border-0 d-flex flex-column justify-content-between align-items-center ps-0 mb-2 border-radius-lg d-md-none">
                        <div class="row px-4">
                            ...
                            <div class="col-4 col-md-2 mb-2 mb-md-0">
                                ...
                                <div class="col-8 col-md-2 mb-2 mb-md-0">
                                    <h6 class="text-dark font-weight-bold text-sm"><?php echo $formattedDate . " / " . $formattedTime ; ?></h6>
                            </div>
                            ...
                            <div class="col-4 col-md-2 mb-2 mb-md-0 text-left text-md-center">
                                <span class="text-xs">Customer</span>
                            </div>

                            <div class="col-8 col-md-2 mb-2 mb-md-0 text-left text-md-center">
                            ...
                            <div class="col-8 col-md-2 mb-2 mb-md-0 text-left text-md-center">
                                <h6 class="text-dark font-weight-bold text-sm"><a href="https://api.whatsapp.com/send?phone=<?php echo $nomorHandphone; ?>" target="_blank"><?php echo $data['cust_nomor'][0]; ?></a></h6>
                            </div>
                            <div class="col-4 col-md-2 mb-2 mb-md-0">
                            ...
                            <div class="col-8 col-md-2 mb-2 mb-md-0 text-left text-md-center justify-content-md-center justify-content-start align-items-center d-flex">
                            ...
                            <div class="col-8 col-md-2 mb-2 mb-md-0 text-left text-md-center justify-content-start justify-content-md-center align-items-center d-flex">
                                <h6 class="mb-1 text-dark font-weight-bold text-sm"><?php echo $data['req_by'][0]; ?></h6>
                            </div>

                            <div class="col-8 col-md-2 mb-2 mb-md-0 d-flex justify-content-md-center justify-content-start align-items-center pt-1">
