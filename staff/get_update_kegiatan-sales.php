<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update_kegiatan"])) {
        ...
        $update_sql = "UPDATE kegiatan SET jenis = '$jenis_kegiatan', keterangan = '$keterangan', tgl_request = '$tgl_request', id_cust = $customer_id, id_teknisi = '$teknisiIdsPertama' WHERE id_kegiatan = $id_kegiatan";
