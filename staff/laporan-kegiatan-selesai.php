...
if (isset($_GET['error'])) {
    ...
    echo "<script>alert('Berhasil update invoice.');</script>";
}
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="row mt-0">
        <div class="col-md-8 col-12 d-flex justify-content-start align-items-center">
            ...
            <a href="laporan-kegiatan-selesai.php" class="btn bg-gradient-info w-md-35 w-45 custom-border-radius-1">Selesai</a>
      ...
      <div class="row mb-4 mt-n3">
        ...
        <?php
        include "laporan-db-kegiatan-selesai.php";
        ?>
