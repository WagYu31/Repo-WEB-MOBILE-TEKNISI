...
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
  <style>
    ...
    /* Custom Scrollbar untuk Riwayat Catatan */
    #reasonHistoryList::-webkit-scrollbar {
        width: 6px; /* Lebar scrollbar lebih tipis */
    }
    #reasonHistoryList::-webkit-scrollbar-track {
        background: #f1f1f1; 
    }
    #reasonHistoryList::-webkit-scrollbar-thumb {
        background: #bbb; 
        border-radius: 10px;
    }
    #reasonHistoryList::-webkit-scrollbar-thumb:hover {
        background: #888; 
    }
