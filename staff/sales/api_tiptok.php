...
if (file_exists(__DIR__ . '/../conn.php')) { require_once __DIR__ . '/../conn.php'; } else if (file_exists(__DIR__ . '/conn.php')) { require_once __DIR__ . '/conn.php'; } else if (file_exists(__DIR__ . '/api_db.php')) { require_once __DIR__ . '/api_db.php'; }
