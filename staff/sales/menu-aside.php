<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      ?>
        <li class="nav-item mt-2 px-3 d-flex justify-content-between">
          <a href="../index-sa.php" class="btn btn-sm btn-outline-light w-45">Teknisi</a>
          <a href="index-sa.php" class="btn btn-sm btn-outline-light w-45">Sales</a>
        </li>

        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Kegiatan</h6>
        </li>
        <li class="nav-item">
