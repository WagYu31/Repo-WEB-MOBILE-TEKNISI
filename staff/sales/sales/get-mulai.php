                ...
                function(position) {
                    ...
                    xhr.onreadystatechange = function() {
                        if (xhr.readyState == 4 && xhr.status == 200) {
                            ...
                            window.location.href = "save-mulai.php?latitude=" + latitude + "&longitude=" + longitude + "&id_visits=<?php echo $id_visits; ?>";
                        }
                    };
                    xhr.send("latitude=" + latitude + "&longitude=" + longitude + "&id_visits=<?php echo $id_visits; ?>");
                },
                function(error) {
