...
<body class="g-sidenav-show  bg-gray-200">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4 col-12 no-print">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <select class="form-select border p-2 w-100" id="tagihanName" name="tagihanName">
                                                <option value=""></option>
                                                <?php
                                                $tagihanQuery = "SELECT * FROM tagihan";
                                                $tagihanResult = mysqli_query($conn, $tagihanQuery);
                                                while ($tagihanRow = mysqli_fetch_assoc($tagihanResult)) {
                                                    $tagihanValue = $tagihanRow['nama_tagihan'];
                                                    $tagihanId = $tagihanRow['id_tagihan'];
                                                ?>
                                                    <option value="<?php echo $tagihanId; ?>"><?php echo $tagihanValue; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
    ...
    <script>
        function cariTagihan() {
            var idTagihan = document.getElementById("tagihanName").value;

            var xhr = new XMLHttpRequest();
            xhr.open("POST", "proses_tagihan.php", true);
