...
<body class="bg-gray-200">
                  ...
                  <div class="row mt-3">
                    <div class="col-12 text-center me-auto">
                      <a class="btn btn-link px-3" href="javascript:;">
                        <span class="text-white text-lg text-center">RUTE12</span>
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body">
                <form role="form" class="text-start" method="POST" action="proses_login.php">
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <input type="text" class="form-control" name="nikUsername" required>
                  </div>
                  <div class="input-group input-group-outline mb-3">
  ...
  <script>
        // Display the alert if loginError is set and not an empty string
        if (loginError !== '') {
            alert(loginError);
        }
    </script>
