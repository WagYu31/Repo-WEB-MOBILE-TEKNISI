                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="card-body px-4 pb-4">
                            <form id="editForm" method="post" action="proses_edit_data_warga.php">
                                <input type="hidden" name="idWarga" value="<?php echo $id_warga;?>">
                                <!-- Personal Information -->
                                <h5 class="mt-4 mb-0">Informasi Personal</h5>
                                <div class="row mb-3">
                                    <div class="col-md-6 mt-2">
                                        <label for="nama" class="form-label">Nama Lengkap</label>
                                        <input type="text" class="form-control border p-2" id="nama" name="nama" value="<?php echo $nama; ?>" required>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <label for="nik" class="form-label">Nomor Induk Kependudukan</label>
                                        <input type="number" class="form-control border p-2" id="nik" name="nik" value="<?php echo $nikSesi; ?>" required>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <input type="number" class="form-control border p-2" id="noKk" name="noKk" value="<?php echo $no_kk; ?>">
                                    </div>
                                    <div class="col-md-6 mt-2">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-2 mt-2">
                                        <label for="kodePos" class="form-label">Kodta</label>
                                        <input type="text" class="form-control border p-2" id="kota" name="kota" value="<?php echo $kota; ?>">
                                    </div>
                                    <div class="col-md-6 mt-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <select class="form-select border p-2" id="pendidikan" name="pendidikan">
                                            ...
                                            <option value="Akademi / Diploma III / S. Muda" <?php echo ($pendidikan == 'Akademi / Diploma III / S. Muda') ? 'selected' : ''; ?>>Akademi / Diploma III / S. Muda</option>
