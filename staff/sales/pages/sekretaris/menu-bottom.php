    ...
    <ul class="navbar-nav nav-justified w-100">
        ...
        <li class="nav-item dropup">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuProfile">
                <a class="dropdown-item" href="tables.php">Data Warga</a>
                <a class="dropdown-item" href="tambah_data_keluarga.php">Tambah Data Keluarga</a>
                <a class="dropdown-item" href="tambah_data_warga.php">Tambah Data Warga</a>
            </div>
        </li>
        <li class="nav-item">
