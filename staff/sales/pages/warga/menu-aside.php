...
<div class="sidenav-header d-flex align-items-center justify-content-center">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-white active bg-gradient-primary" href="tagihan-warga.php">
      ...
      <li class="nav-item">
        <a class="nav-link text-white " href="sedekah.php">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">volunteer_activism</i>
          </div>
          <span class="nav-link-text ms-1">Sedekah</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white " href="status_pembayaran.php">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
