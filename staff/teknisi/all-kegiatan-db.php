...
$sql = "SELECT k.id_teknisi, k.id_kegiatan, k.*, t.nama AS nama_teknisi, c.nama AS nama_customer
        ...
        AND k.status != 'N'
        AND DATE(k.tgl_request) < '$current_date'
                    ...
                    <ul class="list-group m-0 mt-4 col-12 d-flex" id="data-tek">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                if ($row["invoice"] === NULL) {
                                    if ($status == 'Clear') {
                                        ...
                                        $invoice = "Kegiatan Belum / Tidak Terselesaikan";
                                    }
                                } else {
                                    $invoice = $row["invoice"];
                                }
                                ...
                                if ($status == 'Clear') {
                                    ...
                                    if($tgl_short == $today) {
                                        ...
                                        $label = '<b>Lanjut Nanti</b><br>Hubungi Admin untuk info lebih lanjut';
                        ...
                        ?>
                                    <li class="list-group-item border-0 d-flex flex-column <?php echo $event['kelas']; ?> mb-3 mx-4" style="border-radius:10px;">
                                        ...
                                        <div class="text-white mt-n3 text-sm font-weight-bold">Invoice : <?php echo $event['invoice']; ?></div>
                                    </li>
                        <?php
                            }
                        } else {
