              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    <!--<label>Role</label><br>-->
                    <!-- Pilih Role -->
                    <select class="form-control mt-4" name="role" id="roleSelect" required>
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <select class="form-control mt-4" name="user_id" id="userSelect" required>
...
<script>
  $('#roleSelect').change(function () {
    ...
    if (selectedRole !== "") {
      ...
      $('#userSelect').html('<option value="">-- Pilih Nama --</option>');
    }
  });
</script>
