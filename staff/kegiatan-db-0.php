...
<div class="col-lg-12 mt-n3 mb-4" id="loadMoreX1" style="display: block;">
    <div class="card h-100 py-3" style="border-top-left-radius:0;">
        ...
        $sql_today = "SELECT k.*, c.nama AS nama_customer, c.telp AS cust_nomor, c.alamat FROM kegiatan k LEFT JOIN customer c ON k.customer_id = c.id WHERE k.status NOT IN ('waiting', 'selesai by admin') AND DATE(k.jadwal) = ? AND k.deleted_at IS NULL ORDER BY k.jadwal ASC";
