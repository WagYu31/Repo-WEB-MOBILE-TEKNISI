...
<?php
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        $query = "SELECT data_warga.*, kartu_keluarga.* FROM data_warga JOIN kartu_keluarga ON data_warga.no_kk = kartu_keluarga.no_kk WHERE data_warga.id_warga = $id_warga;";
                            ...
                            <form id="editForm" method="post" action="edit_data_warga.php">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <input type="number" class="form-control border p-2" id="noKk" name="noKk" value="<?php echo $no_kk; ?>" disabled>
                                    </div>
                                    <!-- <div class="col-md-3">
