      ...
      <script>
        $(document).ready(function() {
            $(".edit-btn").click(function() {
                ...
                window.location.href = "edit_data_warga.php?nik=" + nik;
            });
        });
    </script>
</head>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td class="align-middle">
                          ...
                          if($past_member == "Y"){
                            ?>
                            <a href="in_member.php?nik=<?php echo $nik;?>" class="btn btn-link text-secondary font-weight-bold text-xs edit-btn">
                            Masuk
                          </a>
                          <?php
                          }
                          ...
                          ?>
                          <a href="past_member.php?nik=<?php echo $nik;?>" class="btn btn-link text-secondary font-weight-bold text-xs edit-btn">
                              Keluar
                            </a>
                            <?php
                          }
