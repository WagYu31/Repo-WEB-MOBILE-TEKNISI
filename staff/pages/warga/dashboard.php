          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php
                $query = "SELECT COUNT(DISTINCT no_kk) as total_kk FROM data_warga";
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Jumlah Anggota Keluarga</p>
                <?php
                $query = "SELECT COUNT(*) as total_warga FROM data_warga WHERE no_kk = '$no_kk'";
                $result = mysqli_query($conn, $query);
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                SELECT jumlah FROM tagihan
                UNION ALL
                SELECT jumlah FROM sedekah
              ) AS combined";
                ...
                $formattedTotalUangMasuk = "Rp " . number_format($totalUangMasuk, 0, ',', '.');

                ?>
                <h4 class="mb-0"><?php echo $formattedTotalUangMasuk; ?></h4>
              </div>
