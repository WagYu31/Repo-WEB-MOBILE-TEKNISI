...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="modal fade" id="detailModal" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true" style="overflow-y:auto; z-index:9999;">
            <div class="modal-dialog modal-dialog-centered modal-xl modalDetail">
                <div class="modal-content">
                    <div class="modal-header">
